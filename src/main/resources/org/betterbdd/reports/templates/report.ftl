    ...
    <tr>
        ...
        <div id="Rules" class="tabcontent">
            ...
            <table border="0">
                ...
                <tr>
                    <td>&emsp;
                        <h3>List of available BDD rules_config</h3>
                    </td>
                </tr>
                ...
                <div id="table-wrapper">
                    <div id="table-scroll">
                        ...
                        <table class="summary-table">
                            <thead>
                            <tr>
                                <th><p style="margin-left: -9px; height: 22px" class="text">Feature</p></th>
<th><p style="margin-left: -9px; height: 22px" class="text">Location</p></th>
